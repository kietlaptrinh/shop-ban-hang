...
$route['gio-hang/info-order'] = 'giohang/info_order';
$route['gio-hang/success'] = 'giohang/paypal_success'; 
$route['gio-hang/cancel'] = 'giohang/paypal_cancel';
...
$route['compare/ajax_compare'] = 'compare/ajax_compare';
