...
<div class="container" style="margin-bottom: 20px;">
    <div class="owl-carousel owl-carousel-product owl-theme" style="border: 1px solid #ffa500;">
        <?php 
    ...
    <div class="container">
        <div class="row-p">
            <div class="text-center">
                <h2 class="sectin-title title title-blue" style="color: #ffa500">Tin tức công nghệ</h2>
            </div>
        </div>
...
" 
onmouseover="this.style.transform='translateY(-5px)'; this.style.boxShadow='0 8px 20px rgba(0,0,0,0.2)'; this.style.backgroundColor='#fff8f0'; this.querySelector('.icon img').style.transform='scale(1.2)'; this.querySelector('.description_icon .large-text').style.color='#ff8c00'; this.querySelector('.description_icon .small-text').style.color='#ff8c00';"
onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0px 1px 5px 2px #f1f1f1'; this.style.backgroundColor=''; this.querySelector('.icon img').style.transform='scale(1)'; this.querySelector('.description_icon .large-text').style.color='#ffa500'; this.querySelector('.description_icon .small-text').style.color='#ffa500';">
                            <div class="icon icon_product">
                                <img src="public/images/icon_142e7.png" alt="">
                            </div>
                            <div class="description_icon">
                                <span class="large-text" style="color: #ffa500">
                                    Miễn phí giao hàng
                                </span>
                                <span class="small-text style="color: #ffa500"">
