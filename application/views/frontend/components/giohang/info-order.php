<?php echo form_open('giohang/info_order', ['enctype' => 'multipart/form-data', 'method' => 'post', 'accept-charset' => 'utf-8', 'name' => 'info-order']); ?>
<?php
    ...
    <div class="container">
        <div class="col-md-12">
            <div class="wrapper overflow-hidden">
                <form action="<?php echo base_url('giohang/info_order'); ?>" enctype="multipart/form-data" method="post" accept-charset="utf-8" name='info-order'>
                    <?php
                                ...
                                <table class="table tinfo" style="width: 80%;">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="1">
                                                <td colspan="1">
    <button type="button" class="btn-next-checkout" onclick="checkCoupon()">Sử dụng</button>
</td>
                                            </td>
                                        </tr>

                                        <tr>
                                            <td class="width30 text-right td-right-order" style="vertical-align: top;">
                                                <h4>Chọn phương thức thanh toán:<span class="require_symbol">* </span></h4>
                                            </td>
                                            <td colspan="2">
                                        ...
                                        <tr>
                                            <td></td>
                                            <td colspan="2">
                                                <button type="submit" class="btn-next-checkout" name="dathang">Xác nhận và Đặt hàng</button>
                                            </td>
                                        </tr>
                                        </tbody>
                                </table>
