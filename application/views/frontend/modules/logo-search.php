<section class="logo-search">
  <div class="container">
    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 logo hidden-xs">
      <a href="<?php echo base_url() ?>"><img src="<?php echo base_url() ?>public/images/logofix3.jpg"></a>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 search">
      <div class="contact-row">
        <div class="phone inline">
          <i class="icon fa fa-phone"></i> (84) 123 456 789
        </div>
        <div class="contact inline">
          <i class="icon fa fa-envelope"></i> leanhtuan03.it@gmail.com
        </div>
      </div>
