                                    ...
                                    <table class="table table-hover table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($data as $row) :
                                                ...
                                                // Nếu sản phẩm không tồn tại, gán tên mặc định
                                                $product_name = ($product && $this->Mproduct->product_detail($product['alias'])) 
                                                    ? $this->Mproduct->product_detail($product['alias'])['name'] 
