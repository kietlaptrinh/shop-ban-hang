		...
		<section class="content-header">
			...
			<div class="breadcrumb">
				...
				<a class="btn btn-primary btn-sm" href="admin/product" role="button">
					<span c	lass="glyphicon glyphicon-remove do_nos"></span> Thoát
				</a>
			</div>
		</section>
		<!-- Main content -->
					...
					<div class="box" id="view">
						<div class="box-body">
							...
							<?php //echo validation_errors(); ?>
								...
								<div class="form-group">
									<label>Mô tả ngắn (Nhập thông số/ý chính để AI hiểu)</label>
  ...
  document.getElementsByName('price_buy')[0].value = price_buy;
	...
	$(document).ready(function() {
        $('#btn-ai-generate').click(function(e) {
            ...
            if (!name) {
                alert('Vui lòng nhập "Tên sản phẩm" trước để AI biết cần viết gì!');
            ...
            $btn.prop('disabled', true).html('<i class="glyphicon glyphicon-refresh"></i> Đang suy nghĩ & viết bài...');
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status === 'success') {
                        ...
                        if (typeof CKEDITOR !== 'undefined' && CKEDITOR.instances['detail']) {
                ...
                error: function(xhr, status, error) {
                    alert('Có lỗi xảy ra khi kết nối tới AI: ' + error);
